...
[**Model Validation and Generalizability**](./ModelValidationAndGeneralizability) - strategy for evaluating training final model, including evaluating generalizability to external datasets.  <br>
